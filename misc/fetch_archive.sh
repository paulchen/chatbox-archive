...
while true; do
	...
	rm -f abc$page.xml
	wget --load-cookies ../tmp/cookies.txt --save-cookies ../tmp/cookies.txt --keep-session-cookies http://www.informatik-forum.at/misc.php?do=ccarc\&page=$page -q -O archive/archive1-$page.xml
	log "processing... "
